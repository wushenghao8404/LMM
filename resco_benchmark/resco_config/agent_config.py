...
from resco_benchmark.agents.neural_tiny import TinyAgent
from resco_benchmark.agents.seq_act import ActSequence
from resco_benchmark.agents.fixed_timer import FixedTiming
from resco_benchmark.agents.neural_wave import NeuralWave
from resco_benchmark.agents.neural_urgency import NeuralUrgency, NeuralUrgency_v2
...
agent_configs = {
    ...
    'NeuralUrgency': {
        'agent': NeuralUrgency,
        'state': states.gplight,
        'reward': rewards.wait,
        'max_distance': 50
    },
    'NeuralUrgency_v2': {
        'agent': NeuralUrgency_v2,
        'state': states.gplight_norm,
