map_configs = {
    'net_single1': {
        'lights': [],
        'net': 'environments/net_single1/net_single1.sumocfg',
        'route': None,
        'step_length': 10,
        'yellow_length': 3,
        'step_ratio': 1,
    ...
    'net_single2': {
        'lights': [],
        'net': 'environments/net_single2/net_single2.sumocfg',
        'route': None,
        'step_length': 10,
        'yellow_length': 3,
        'step_ratio': 1,
    ...
    'net_single3': {
        'lights': [],
        'net': 'environments/net_single3/net_single3.sumocfg',
        'route': None,
        'step_length': 10,
        'yellow_length': 3,
        'step_ratio': 1,
    ...
    'net_double': {
        'lights': [],
        'net': 'environments/net_double/net_double.sumocfg',
        'route': None,
        'step_length': 10,
        'yellow_length': 3,
        'step_ratio': 1,
    ...
    'net_2x2grid': {
        'lights': [],
        'net': 'environments/net_2x2grid/net_2x2grid.sumocfg',
        'route': None,
        'step_length': 10,
        'yellow_length': 3,
        'step_ratio': 1,
    ...
    'net_3x3grid': {
        'lights': [],
        'net': 'environments/net_3x3grid/net_3x3grid.sumocfg',
        'route': None,
        'step_length': 10,
        'yellow_length': 3,
        'step_ratio': 1,
