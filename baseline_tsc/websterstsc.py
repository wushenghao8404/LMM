...
class WebstersTSC(TrafficSignalController):
    def __init__(self, conn, tsc_id, netdata, red_t, yellow_t, g_min, c_min, c_max, sat_flow=0.38, update_freq=None):
        super().__init__(conn, tsc_id, netdata, red_t, yellow_t)
